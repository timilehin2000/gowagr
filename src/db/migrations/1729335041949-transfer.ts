...
export class Transfer1729335041949 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "user" RENAME COLUMN "walletBalance" TO "balance"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transfer" ADD CONSTRAINT "FK_780bd0b359a2b4576b2e3268600" FOREIGN KEY ("senderId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transfer" ADD CONSTRAINT "FK_6bad5b656535794d899c2a50323" FOREIGN KEY ("receiverId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "transfer" DROP CONSTRAINT "FK_6bad5b656535794d899c2a50323"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transfer" DROP CONSTRAINT "FK_780bd0b359a2b4576b2e3268600"`,
    );
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "balance"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user" RENAME COLUMN "balance" TO "walletBalance"`,
    );
  }
}
